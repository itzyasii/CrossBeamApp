  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.background }]}>
      ...
      <View style={styles.header}>
        <Text style={[styles.title, { color: colors.textPrimary }]}>CrossBeam</Text>
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>Share files quickly, privately, and offline.</Text>
